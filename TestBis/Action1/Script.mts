...
Browser("Advantage Shopping_2").Page("Advantage Shopping").Image("fetchImage?image_id=4200").Click @@ script infofile_;_ZIP::ssf5.xml_;_
Browser("Advantage Shopping_2").Page("Advantage Shopping").Link("dvantage DEMO").Click @@ script infofile_;_ZIP::ssf6.xml_;_
